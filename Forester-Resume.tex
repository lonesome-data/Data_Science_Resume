...
{ 
Data Science Consultant. Technical lead capable of individually contributing to machine learning prototypes. Penchant for problem framing and communicating data-driven solutions to decision makers. %built through hands-on experience after earning M.S. in Computer Science. %Available in September. 
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     COLUMN ONE
